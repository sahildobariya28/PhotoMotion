...
public class CustomAnimationView extends ConstraintLayout implements OnClickListener {
    ...
    public ConstraintLayout moRlMainLayout;
    ...
    public class BitmapTask extends AsyncTask<Void, Void, Boolean> {
        ...
        public Boolean doInBackground(Void... voidArr) {
            ...
            while (i < 30) {
                try {
                    final int finalI = i;
                    moActivity.runOnUiThread(() -> {
                        animationView.setFrame(finalI + 1);
    ...
    public void init() {
        ...
        this.moRlMainLayout = this.mCustomView.findViewById(R.id.main_layout);
