package photo.photomotion.motion.photomotionlivewallpaper.fragment;
...
public class ProgressDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        ((ProgressBar) inflate.findViewById(R.id.progress)).getIndeterminateDrawable().setColorFilter(getContext().getResources().getColor(R.color.secondary), Mode.SRC_IN);
        return inflate;
    }
