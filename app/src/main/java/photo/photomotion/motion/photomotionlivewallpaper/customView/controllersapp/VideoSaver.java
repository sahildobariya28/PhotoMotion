...
import photo.photomotion.motion.photomotionlivewallpaper.customView.FFMPEGSaver;
...
public class VideoSaver extends AsyncTask<Object, Integer, String> {
    ...
    public VideoSaver(Activity context2, Project projeto2, int i, int i2) {
        context = context2;
        projeto = projeto2;
        miWidth = i;
        miHeight = i2;
    ...
    public String doInBackground(Object... objArr) {
        ...
        for (Point copia : projeto.getListaPontos()) {
        ...
        while (i2 < totalFrames) {
            ...
            Bitmap frameEmMovimento = FrameController.getInstance().getFrameMotion(delaunay, tempoAnimacao, fps, f4, Config.ARGB_8888);
            float f5 = f4;
            float f6 = ((((float) tempoAnimacao) / 2.0f) + f5) % ((float) tempoAnimacao);
            Paint paint5 = paint2;
            float f7 = f5;
            Bitmap frameEmMovimento2 = FrameController.getInstance().getFrameMotion(delaunay, tempoAnimacao, fps, f6, Config.ARGB_8888);
