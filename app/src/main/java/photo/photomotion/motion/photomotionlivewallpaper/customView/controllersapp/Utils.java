...
public class Utils {
    ...
    public static float dpiToPixels(float f) {
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, f, MotionEditActivity.metrics);
    }
    ...
    public static void scannFile(Context context, File file) {
        ...
        if (VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            mSelectedImageUri = FileProvider.getUriForFile(context, "photo.photomotion.motion.photomotionlivewallpaper" + ".provider", file);
        }
    ...
    public static Uri writeImageAndGetPathUri(Context context, Bitmap bitmap, String str) throws Exception {
        File file = new File(getPrivateAlbumStorageDir(context, context.getResources().getString(R.string.app_name)), str+".png");
