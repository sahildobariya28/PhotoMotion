...
public class Point implements Parcelable {
    ...
    public Point getCopia(float f) {
        Point ponto = new Point(this.xInit * f, this.yInit * f, this.xFim * f, this.yFim * f);
    ...
    public float coeficienteAngular(Point ponto) {
        return (ponto.getYInit() - this.yInit) / (ponto.getXInit() - this.xInit);
    }

    public boolean naCircunferencia(Point ponto, Point ponto2) {
        Point mediana = ponto.mediana(ponto2);
        return naCircunferencia(mediana, mediana.distanciaPara(ponto));
    }

    public boolean naCircunferencia(Point ponto, double d) {
        return ponto.distanciaPara(this) <= d;
    }

    public double distanciaPara(Point ponto) {
    ...
    public Point mediana(Point ponto) {
        return new Point((ponto.getXInit() + getXInit()) / 2.0f, (ponto.getYInit() + getYInit()) / 2.0f, true);
    }

    public Point sub(Point ponto) {
        return new Point(this.xInit - ponto.xInit, this.yInit - ponto.yInit, true);
    }

    public Point add(Point ponto) {
        return new Point(this.xInit + ponto.xInit, this.yInit + ponto.yInit, true);
    }
    ...
    public Point mult(double d) {
        ...
        Double.isNaN(d3);
        return new Point(f, (float) (d3 * d), true);
    }
    ...
    public double dot(Point ponto) {
        return (double) ((this.xInit * ponto.xInit) + (this.yInit * ponto.yInit));
    }

    public double cross(Point ponto) {
