...
import photo.photomotion.motion.photomotionlivewallpaper.callback.OnStickerClickListener;
...
public class StickerAdapter extends Adapter<StickerAdapter.ViewHolder> {
    ...
    public OnStickerClickListener moOnClickListner;
    ...
    public StickerAdapter(Context context, List<StickerData> list, Bitmap bitmap, OnStickerClickListener onStickerClickListner) {
            ...
            public void onSingleClick(View view) {
               ...
               // int i = stickerAdapter.checkedPosition;
                if (checkedPosition != i) {
                    ...
                    stickerAdapter.moOnClickListner.onClick(moStickerList.get(i), i);
                }
            }
        });
    }
